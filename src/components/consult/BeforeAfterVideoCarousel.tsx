...
export default function BeforeAfterVideoCarousel() {
  ...
  return (
    <section className="relative isolate overflow-hidden bg-linear-to-b from-brand-deep to-brand-deeper px-2 py-8 text-white sm:px-8 sm:py-14 lg:py-14">
      {/* soft background glows + dot texture */}
      <div aria-hidden className="pointer-events-none absolute inset-0 -z-10">
        <div className="absolute left-1/2 top-[-12rem] h-[28rem] w-[40rem] -translate-x-1/2 rounded-full bg-primary/25 blur-3xl" />
        <div className="absolute -bottom-40 -left-32 h-80 w-80 rounded-full bg-secondary-fixed/10 blur-3xl" />
      ...
      {/* heading */}
      <div className="mx-auto mb-10 max-w-3xl space-y-3 px-3 text-center sm:mb-12">
